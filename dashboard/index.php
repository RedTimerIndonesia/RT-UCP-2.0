...
<head>
  ...
  <title>RT:RP - Dashboard Index</title>
...
<body>
  ...
  <div class="page-content">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
          <h4><b>Character Information:</b></h4>
          <hr>
            ...
            <table class="table table-def table-condensed table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="progress">
                      <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" style="width: <?= $data["health"]; ?>%;" aria-valuenow="<?= $data["health"]; ?>" aria-valuemin="0" aria-valuemax="100"><?= $data["health"]; ?></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="progress">
                      <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" style="width: <?= $data["armour"]; ?>%;" aria-valuenow="<?= $data["armour"]; ?>" aria-valuemin="0" aria-valuemax="100"><?= $data["armour"]; ?></div>
                    </div>
                  </td>
                </tr>
              </tbody>
  ...
  <script src="../assets/js/dashboard/slide-nav.js"></script>
</body>
