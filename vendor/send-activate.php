...
$pesan = "
    <p>To: <br>Username: <b>$user</b><br><br>
        ...
        <a href='http://ucp.redtimer.xyz/register?page=activation&t=$token'>
            http://ucp.redtimer.xyz/register?page=activation&t=$token
        </a><br><br>
...
$mail->Host = 'dci16.dewaweb.com';
$mail->Username = $email_pengirim; // Email Pengirim
$mail->Password = 'b[fN2JeA1V.y'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
