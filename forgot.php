      ...
      <div class="card border-info mx-auto">
        <div class="container">
          <div class="card-header">
            <h3 class="card-title">RT:RP - Reset Password</h3>
          </div>
          <div class="card-body">
  ...
  <?php else : ?>
    <div class="container">
      <div class="card border-info mx-auto">
        <div class="container">
          <div class="card-header">
            <h3 class="card-title">RT:RP - Forgot Page</h3>
          </div>
          <div class="card-body">
            <div class="form-group">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">RT:RP - Forgot Password</h5>
    ...
    <div class="modal fade" id="modal-username" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">RT:RP - Forgot Username</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <div class="modal fade" id="modal-email" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">RT:RP - Forgot Email</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
